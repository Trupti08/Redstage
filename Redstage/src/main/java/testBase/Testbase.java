...
public class Testbase {
	...
	public void startBrowser() throws IOException {
		...
		String url = ExcelRead.getObject("url");

		String browser = ExcelRead.getObject("browser");
		...
		case "android":
			// Code to be implemented
			// driver = initAndroidDriver(appURL);
			break;
		default:
	...
	public void startBrowserAdmin() throws IOException {

		String url = ExcelRead.getObject("adminurl");
		String browser = ExcelRead.getObject("browser");
		...
		case "android":
			...
			break;
		default:
			Log.log.error("browser : " + browser + " is invalid, Launching Firefox as browser of choice..");
			driver = initFirefoxDriver(url);
		}
		// return driver;
	}
	...
	private static WebDriver initChromeDriver(String appURL) {
		...
		Log.log.info("Launching google chrome with new profile..");
		System.setProperty("webdriver.chrome.driver", configPath + "\\Drivers\\chromedriver.exe");
	...
	private static WebDriver initFirefoxDriver(String appURL) {
		...
		Log.log.info("Launching Firefox browser..");
		System.setProperty("webdriver.gecko.driver", configPath + "\\Drivers\\chromedriver.exe");
	...
	public boolean isTextDisplay(String xpath, String input, String methodName, boolean scrShot) {

		try {
			element = driver.findElement(By.xpath(waitForWebElement(xpath, 15000)));

			AssertJUnit.assertEquals(element.getText(), input);
